...
const hashPaidByPaymaster =
  '0x111b4d03dd8c01f1049143cf9c4c817e4b167f1d1b83e5c6f0f10d89ba1e7bce';
...
vi.mock('ohmyfetch', async () => {
  ...
  const transactionDetails = {
    ...
    blockHash:
      '0x1fc6a30903866bf91cede9f831e71f2c7ba0dd023ffc044fe469c51b215d950b',
    transactionIndex: 0,
    receivedAt: '2023-02-28T08:42:08.198Z',
    status: 'verified',
    commitTxHash:
      '0xe6a7ed0b6bf1c49f27feae3a71e5ba2aa4abaa6e372524369529946eb61a6936',
    executeTxHash:
      '0xdd70c8c2f59d88b9970c3b48a1230320f051d4502d0277124db481a42ada5c33',
    proveTxHash:
      '0x688c20e2106984bb0ccdadecf01e7bf12088b0ba671d888eca8e577ceac0d790',
    gasPrice: '4000',
    gasLimit: '5000',
    gasUsed: '3000',
    gasPerPubdata: '800',
  ...
  return {
    ...
    $fetch: vi.fn((url: string) => {
      if (
        url.endsWith(`/transactions/${hash}`) ||
        url.endsWith(`/transactions/${hashPaidByPaymaster}`)
      ) {
      ...
      if (
        url.endsWith(
          `transactions/${hashPaidByPaymaster}/transfers?limit=100&page=1`,
        )
      ) {
        return Promise.resolve({
          items: [
...
describe('useTransaction:', () => {
  ...
  describe('getByHash:', () => {
    ...
    it('sets isRequestFailed to true when request failed', async () => {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      const mock = ($fetch as any).mockRejectedValue(
